...
describe('AdvancedGovernanceToken', function () {
    ...
    describe('Staking Functionality', function () {
        ...
        it('Should not allow unstaking during lock period', async function () {
            ...
            await expect(token.connect(user1).unstake(stakeAmount)).to.be.revertedWith(
    ...
    describe('Compliance Features', function () {
        ...
        it('Should enforce whitelist when enabled', async function () {
            ...
            await expect(token.connect(user1).transfer(user2.address, transferAmount)).to.not.be
                .reverted;
        });
        ...
        it('Should enforce transfer amount limits', async function () {
            ...
            await expect(token.connect(user1).transfer(user2.address, maxTransfer)).to.not.be
                .reverted;
        });
    ...
    describe('View Functions', function () {
        ...
        it('Should check transfer eligibility correctly', async function () {
            ...
            expect(await token.canTransfer(user1.address, user2.address, transferAmount)).to.be
                .true;
    ...
    describe('Edge Cases and Security', function () {
        ...
        it('Should handle insufficient balance for staking', async function () {
            ...
            await expect(token.connect(user1).stake(stakeAmount, 0)).to.be.revertedWith(
        ...
        it('Should handle unstaking more than staked', async function () {
            ...
            await expect(token.connect(user1).unstake(unstakeAmount)).to.be.revertedWith(
        ...
        it('Should handle reentrancy protection', async function () {
            ...
            expect(
                token.interface.fragments.some((f) => f.type === 'function' && f.name === 'stake'),
            ).to.be.true;
        });
    });
