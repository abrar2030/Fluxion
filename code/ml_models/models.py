...
class SupplyChainForecaster(nn.Module):
    def __init__(self, input_size=12, hidden_size=128, num_layers=3, dropout=0.2):
        ...
        self.fc2 = nn.Linear(
            hidden_size // 2, 5
        )  # 5 outputs for different status predictions
...
def train_liquidity_model(
    data_path=None, epochs=100, save_path="liquidity_predictor.pt"
):
    """
...
def train_supply_chain_model(
    data_path=None, epochs=100, save_path="supply_chain_forecaster.pt"
):
    """
