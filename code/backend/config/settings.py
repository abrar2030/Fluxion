...
class AppSettings(BaseSettings):
    ...
    APP_DESCRIPTION: str = Field(default="Production-ready DeFi Supply Chain Platform", env="APP_DESCRIPTION")
...
class BlockchainSettings(BaseSettings):
    ...
    GOVERNANCE_TOKEN_ADDRESS: Optional[str] = Field(None, env="GOVERNANCE_TOKEN_ADDRESS")
...
class ExternalServicesSettings(BaseSettings):
    ...
    NOTIFICATION_SERVICE_URL: Optional[str] = Field(None, env="NOTIFICATION_SERVICE_URL")
