...
from services.user.user_service import UserService, UserType, UserStatus
...
class TestUserService:
    ...
    @pytest.mark.asyncio
    async def test_authenticate_user_invalid_credentials(self, user_service, sample_user_data):
    ...
    @pytest.mark.asyncio
    async def test_authenticate_user_unverified_email(self, user_service, sample_user_data):
    ...
    async def test_verify_email_success(self, user_service, sample_user_data):
        ...
        # Verify email
        result = await user_service.verify_email(registration_result["verification_token"])
    ...
    async def test_get_user_profile_success(self, user_service, sample_user_data):
        ...
        assert profile["profile"]["first_name"] == sample_user_data["profile_data"]["first_name"]
        assert profile["profile"]["last_name"] == sample_user_data["profile_data"]["last_name"]
    ...
    async def test_password_strength_validation(self, user_service):
        ...
        for weak_password in weak_passwords:
            ...
            assert is_strong is False, f"Password '{weak_password}' should be considered weak"
        ...
        for strong_password in strong_passwords:
            ...
            assert is_strong is True, f"Password '{strong_password}' should be considered strong"
