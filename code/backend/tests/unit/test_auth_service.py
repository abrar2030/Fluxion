...
class TestAuthService:
    ...
    async def test_register_user_success(self, test_db, auth_service, sample_user_register):
    ...
    async def test_register_user_duplicate_email(self, test_db, auth_service, sample_user_register):
    ...
    async def test_register_user_duplicate_username(self, test_db, auth_service, sample_user_register):
    ...
    async def test_authenticate_user_success(self, test_db, auth_service, test_user, sample_user_login):
        """Test successful user authentication."""
        # Update test user to match login data
        test_user.email = sample_user_login.email
        test_user.hashed_password = auth_service._hash_password(sample_user_login.password)
    ...
    async def test_authenticate_user_invalid_email(self, test_db, auth_service, sample_user_login):
    ...
    async def test_authenticate_user_invalid_password(self, test_db, auth_service, test_user, sample_user_login):
    ...
    async def test_authenticate_user_locked_account(self, test_db, auth_service, test_user, sample_user_login):
    ...
    async def test_authenticate_user_unverified_email(self, test_db, auth_service, test_user, sample_user_login):
    ...
    async def test_change_password_invalid_current(self, test_db, auth_service, test_user):
    ...
    async def test_verify_email_already_verified(self, test_db, auth_service, test_user):
    ...
    async def test_get_user_by_email_not_found(self, test_db, auth_service):
        ...
        found_user = await auth_service._get_user_by_email(test_db, "nonexistent@example.com")
        
        assert found_user is None
    
    async def test_get_user_by_username(self, test_db, auth_service, test_user):
        """Test getting user by username."""
        found_user = await auth_service._get_user_by_username(test_db, test_user.username)
