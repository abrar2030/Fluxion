            ...
            <CardBody>
              ...
              <FormControl mb={4}>
                ...
                <HStack spacing={4}>
                  ...
                  <Text color="white" fontWeight="bold" w="60px" textAlign="right">
                    {fee.toFixed(2)}%
                  </Text>
                </HStack>
              </FormControl>
              ...
              <FormControl>
                ...
                <Text color="gray.400" fontSize="sm" mt={1}>
                  Higher values increase price stability for stablecoins (20-100 recommended for volatile assets)
                </Text>
              </FormControl>
            </CardBody>
          </Card>
            ...
            <CardBody>
              ...
              <VStack spacing={3} align="stretch">
                <Flex justify="space-between">
                  ...
                  <Text color="white">{fee.toFixed(2)}%</Text>
                </Flex>
                <Flex justify="space-between">
                  <Text color="gray.300">Amplification Factor:</Text>
                  <Text color="white">{amplification}</Text>
                </Flex>
                <Flex justify="space-between">
                  <Text color="gray.300">Expected APY Range:</Text>
                  <Text color="green.400">4.5% - 8.2%</Text>
                </Flex>
              </VStack>
            </CardBody>
          </Card>
