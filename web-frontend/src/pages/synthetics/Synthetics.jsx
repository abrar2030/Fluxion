                ...
                >
                    <Box mb={{ base: 6, md: 0 }}>
                        ...
                        <Text fontSize="lg" color={subTextColor} maxW="600px">
                            Trade synthetic assets that track the price of real-world assets without
                            owning the underlying asset. Access global markets 24/7.
                        </Text>
                    </Box>
            ...
            {isConnected ? (
                ...
                >
                    ...
                    <Text color={subTextColor} maxW="600px" mx="auto" mb={6}>
                        Connect your wallet to mint synthetic assets, manage your positions, and
                        trade on the Fluxion platform.
                    </Text>
                    <Button
                        size="lg"
                        colorScheme="brand"
                                                ...
                                                <CardBody>
                                                    <HStack align="start" spacing={4}>
                                                        ...
                                                        <Box>
                                                            ...
                                                            <Text fontSize="sm">
                                                                To mint synthetic assets, users must
                                                                provide collateral in excess of the
                                                                value of the synthetic assets they
                                                                wish to create. This
                                                                over-collateralization ensures the
                                                    ...
                                                    <HStack align="start" spacing={4}>
                                                        ...
                                                        <Box>
                                                            ...
                                                            <Text fontSize="sm">
                                                                ...
                                                                (like Chainlink) provide real-time
                                                                price data for the underlying
                                                                assets, ensuring that synthetic
                                                                assets accurately track their
                                                    ...
                                                    <HStack align="start" spacing={4}>
                                                        ...
                                                        <Box>
                                                            ...
                                                            <Text fontSize="sm">
                                                                ...
                                                                falls below the required ratio, your
                                                                position may be liquidated. This
                                                                means your collateral will be sold
                                                                to repay the synthetic assets you've
                                                                minted.
                                                            </Text>
                                                        </Box>
                                                    </HStack>
                                                ...
                                                <CardBody>
                                                    <HStack align="start" spacing={4}>
                                                        ...
                                                        <Box>
                                                            ...
                                                            <Text fontSize="sm">
                                                                Once minted, synthetic assets can be
                                                                freely traded on decentralized
                                                                exchanges or used in other DeFi
                                                                protocols, just like any other
                                                                token.
                                                            </Text>
                                                        </Box>
                                                    </HStack>
                                    ...
                                    >
                                        <Flex>
                                            ...
                                            <Box>
                                                ...
                                                <Text fontSize="sm">
                                                    Synthetic assets involve risk. Price volatility
                                                    of the underlying asset can lead to liquidations
                                                    if collateral ratios are not maintained. Always
                                                    monitor your positions and maintain healthy
