...
import { FiPackage, FiPlus, FiExternalLink, FiAlertCircle, FiCheckCircle } from 'react-icons/fi';
      ...
      {activeTab === 'explore' ? (
        <Box>
          <Card bg={cardBg} borderColor={borderColor} borderWidth="1px" borderRadius="lg" mb={8} className="slide-up">
            <CardBody>
              <Heading size="md" mb={4} color="white">Available Synthetic Assets</Heading>
              <Box overflowX="auto">
                <Table variant="simple" colorScheme="whiteAlpha">
                  ...
                  <Tbody>
                    {syntheticAssets.map((asset) => (
                      <Tr key={asset.id}>
                        <Td fontWeight="bold" color="white">{asset.id}</Td>
                        <Td>{asset.name}</Td>
                        <Td>{asset.price}</Td>
                        <Td>{asset.oracle}</Td>
                        <Td>{asset.collateral}</Td>
                        <Td>
                          <Badge colorScheme={asset.status === 'active' ? 'green' : 'red'}>
            ...
            <Card bg={cardBg} borderColor={borderColor} borderWidth="1px" borderRadius="lg" className="slide-up">
              <CardBody>
                ...
                <VStack spacing={4} align="stretch">n="stretch">
                  ...
                  <Flex justify="space-between" align="center">
                    <Text color="gray.300">Active Assets:</Text>
                    <Text color="white" fontWeight="bold">4</Text>
                  </Flex>
                  <Flex justify="space-between" align="center">
                    <Text color="gray.300">Total Market Cap:</Text>
                    <Text color="white" fontWeight="bold">$12.4M</Text>
                  </Flex>
                  <Flex justify="space-between" align="center">
                    <Text color="gray.300">24h Trading Volume:</Text>
                    <Text color="white" fontWeight="bold">$3.2M</Text>
                  </Flex>
                  <Flex justify="space-between" align="center">
                    <Text color="gray.300">Total Collateral Locked:</Text>
                    <Text color="white" fontWeight="bold">$18.7M</Text>
                  </Flex>
                </VStack>
              </CardBody>
            </Card>
                ...
                <VStack spacing={4} align="stretch">n="stretch">
                  {[
                    ...
                    >
                      ...
                      <HStack>
                        <Badge colorScheme={oracle.status === 'Connected' ? 'green' : 'red'}>
                          {oracle.status}
                        </Badge>
              ...
              <CardBody>
                ...
                <FormControl mb={4}>
                  ...
                  <NumberInput
                    ...
                    min={120}
                    max={300}
                    onChange={(valueString) => setNewAsset({...newAsset, collateral: parseInt(valueString)})}
                    bg="gray.800"
                    color="white"
                    borderColor="gray.600"
                  >
              ...
              <CardBody>
                ...
                >
                  <VStack spacing={3} align="stretch">
                    <Flex>
                      <Icon as={FiAlertCircle} color="yellow.400" mt={1} mr={2} />
                      <Text color="gray.300">
                        <Text as="span" color="white" fontWeight="medium">Collateral Risk:</Text> {' '}
                        {newAsset.collateral >= 180 ? 'Low' : newAsset.collateral >= 150 ? 'Medium' : 'High'}
                      </Text>
                    </Flex>
                    <Flex>
                      <Icon as={FiAlertCircle} color="green.400" mt={1} mr={2} />
                      <Text color="gray.300">
                        <Text as="span" color="white" fontWeight="medium">Oracle Risk:</Text> {' '}
                        {newAsset.oracle === 'Chainlink' ? 'Low' : 'Medium'}
                      </Text>
                    </Flex>
                    <Flex>
                      <Icon as={FiExternalLink} color="blue.400" mt={1} mr={2} />
                      <Text color="gray.300">
                        <Text as="span" color="white" fontWeight="medium">Market Liquidity:</Text> {' '}
