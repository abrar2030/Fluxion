...
const Dashboard = () => {
    ...
    const { marketData, poolsData, analyticsData, fetchMarketData, fetchPoolsData, isLoading } =
        useData();
                    ...
                    <CardBody>
                        ...
                        >
                            <Box mb={{ base: 4, md: 0 }}>
                                ...
                                <Text color="gray.300">
                                    Connect your wallet to start creating and managing liquidity
                                    pools and synthetic assets.
                                </Text>
                            </Box>
