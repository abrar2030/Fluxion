...
import { Box, Flex, VStack, HStack, Heading, Text, Button, useColorModeValue, Icon, useDisclosure, Drawer, DrawerOverlay, DrawerContent, DrawerCloseButton, DrawerHeader, DrawerBody, Image } from '@chakra-ui/react';
import { FiMenu, FiHome, FiDroplet, FiBarChart2, FiSettings, FiDollarSign, FiExternalLink } from 'react-icons/fi';
  ...
  return (
    ...
    >
      <Flex h="20" alignItems="center" mx="8" justifyContent="space-between">
        ...
        <Heading as="h1" fontSize="xl" fontFamily="heading" letterSpacing="tight">
          Fluxion
        </Heading>
      </Flex>
