...
const recentTransactions = [
  { id: 1, asset: 'Asset 1', from: '0x123...', to: '0x456...', timestamp: '2023-05-18 14:30', status: 'Completed' },
  { id: 2, asset: 'Asset 2', from: '0x789...', to: '0xabc...', timestamp: '2023-05-18 13:45', status: 'Pending' },
  { id: 3, asset: 'Asset 3', from: '0xdef...', to: '0x123...', timestamp: '2023-05-18 12:20', status: 'Completed' },
  { id: 4, asset: 'Asset 4', from: '0x456...', to: '0x789...', timestamp: '2023-05-18 11:10', status: 'Failed' },
];
      ...
      <Box component="main" sx={{ flexGrow: 1, overflow: 'auto' }}>
        ...
        >
          <Toolbar>
            <IconButton
              ...
              sx={{ mr: 2, display: { sm: 'block', md: !drawerOpen ? 'block' : 'none' } }}
            >
              <MenuIcon />
            </IconButton>
            <Box sx={{ flexGrow: 1 }} />
        ...
        <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
          ...
          <Grid container spacing={3} sx={{ mb: 4 }}>
            {[
              { title: 'Total Assets', value: '1,234', color: theme.palette.primary.main },
              { title: 'In Transit', value: '256', color: theme.palette.warning.main },
              { title: 'Delivered', value: '789', color: theme.palette.success.main },
                  ...
                  <Paper sx={{ p: 3, height: '100%' }}>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                      <AreaChart data={liquidityData}>
                        ...
                        <Tooltip />
                        <Legend />
                        <Area type="monotone" dataKey="value" stroke={theme.palette.primary.main} fill={theme.palette.primary.main + '80'} />
                      </AreaChart>
                    </ResponsiveContainer>
                  </Paper>
                </Grid>
                ...
                <Grid item xs={12}>
                  <Paper sx={{ p: 3 }}>
                    ...
                    <Box sx={{ overflowX: 'auto' }}>
                      <Box sx={{ minWidth: 650 }}>
                        <Box sx={{ display: 'flex', fontWeight: 'bold', borderBottom: `1px solid ${theme.palette.divider}`, py: 1.5 }}>
                        ...
                        {recentTransactions.map((tx) => (
                          <Box key={tx.id} sx={{ display: 'flex', borderBottom: `1px solid ${theme.palette.divider}`, py: 1.5 }}>
