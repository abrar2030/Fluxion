...
describe('ResultsDisplay', () => {
  const mockResults = {
    ...
    confidence_intervals: {
      'meter1': [[9.8, 11.2], [10.5, 11.9]],
      'meter2': [[19.0, 21.2], [20.0, 22.6]]
    },
  ...
  it('handles array-based predictions structure', () => {
    const arrayResults = {
      ...
      confidence_intervals: [[9.8, 11.2], [10.5, 11.9]],
      model_version: 'fluxora-v1.2-lstm'
    };
  ...
  it('applies theme colors correctly', () => {
    ...
    expect(predictionValue.props.style).toContainEqual({ color: expect.any(String) });
