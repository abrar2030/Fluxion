...
describe('ResultsScreen', () => {
  ...
  const mockRoute = {
    params: {
      predictionData: {
        ...
        confidence_intervals: { 'meter1': [[9.8, 11.2], [10.5, 11.9]], 'meter2': [[19.0, 21.2], [20.0, 22.6]] },
  ...
  it('renders the results display with prediction data', () => {
    ...
    expect(resultsDisplay.props.children).toBe(JSON.stringify(mockRoute.params.predictionData));
  });
