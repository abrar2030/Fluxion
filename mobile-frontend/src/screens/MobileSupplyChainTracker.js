...
const MobileSupplyChainTracker = () => {
    ...
    const handleTransferAsset = () => {
        ...
        setTimeout(() => {
            ...
            const newTransfer = {
                ...
                location:
                    transferDetails.location || (currentLocation ? 'Current Location' : 'Unknown'),
                proofHash:
    ...
    const renderAssetItem = ({ item }) => (
        <TouchableOpacity
            style={[styles.assetItem, selectedAsset?.id === item.id && styles.selectedAssetItem]}
        ...
        <SafeAreaView style={styles.container}>
            ...
            {loading && assets.length === 0 ? (
                ...
                <ScrollView style={styles.assetDetailContainer}>
                    ...
                    {/* Asset QR Code */}
                    <TouchableOpacity style={styles.qrCodeCard} onPress={() => setShowQRCode(true)}>
            ...
            {selectedAsset && (
                <TouchableOpacity style={styles.backButton} onPress={() => setSelectedAsset(null)}>
